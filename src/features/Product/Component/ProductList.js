      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-12">
            <h1 className="text-4xl font-bold tracking-wide text-gray-800 font-roboto">Our Products</h1>
          ...
          {products.map((product) => (
            <div key={product.id} className="group relative border border-gray-300 p-2 rounded-md ">
              ...
              <div className="mt-4 flex justify-between">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900 ">${Math.round(product.price * (1 - product.discountPercentage / 100))}</p>
                  <p className="text-sm font-medium text-gray-400 mt-2 line-through">${product.price}</p>
                </div>
...
function PaginationBottom({ handlePage, page, setPage, totalItems }) {
  return (
          ...
          <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            {Array.from({ length: Math.ceil(totalItems / ITEMS_PER_PAGE) }).map((el, index) => (
              <div
               ...
               ${index + 1 === page ? 'bg-indigo-600 text-white' : 'text-gray-400 border border-gray-300'} px-4 py-2 text-sm font-semibold focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
              >
                {index + 1}
              </div>
            ))
